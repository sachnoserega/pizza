                ...
                <div className="content__items">
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img
                                ...
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5eH9MJXzX8ceEgMJ7-oGvEPhelSQs6ZP4_lXVv1MD1QpgyQWdY0rq1mGkN6LT9ZHgDYY&usqp=CAU"
                                alt="Pizza"
                            />
                        </div>
                    ...
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img
                                className="pizza-block__image"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWB_rV9wStL7AIoMsqTuzYTFkRf73k9JExwLb5BKKzUlfrtKCynN32EcP6rNnWrrT72nk&usqp=CAU"
                                alt="Pizza"
                            />
                        </div>
                        <div className="cart__item-info">
                    ...
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img
                                className="pizza-block__image"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxTMZkVGebKZtcoUZfQ7ZsXrCI3cpUO13SKP3i4oaUcjAg1aH3wz6ypcFohITAQfZLMvc&usqp=CAU"
                                alt="Pizza"
                            />
                        </div>
                        <div className="cart__item-info">
                    ...
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img
                                className="pizza-block__image"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStlOOHtk-lkO9xXPaYaUtcmm1mDz1PHyVFnzXAPWWwUU4wddwrgYtLNTVLKraEsQ8JZxA&usqp=CAU"
                                alt="Pizza"
                            />
                        </div>
                        <div className="cart__item-info">
